...
Spend: production is **economy** (`XAI_ECONOMY=economy` on runner + Worker, 2026-08-30). `XAI_ECONOMY=full` is max volume. Staging is spend-dark unless opted in (`src/lib/spendGuard.ts`).

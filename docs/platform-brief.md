...
Spend: production is **full** (`XAI_ECONOMY=full` on runner + Worker, 2026-08-29). `XAI_ECONOMY=economy` throttles. Staging is spend-dark unless opted in (`src/lib/spendGuard.ts`).

...
- People in the news: `npm run check:people` (extractor fixtures + last-week strip preview). Staging home signed view should mix non-officeholders (actors, CEOs, etc.) with politicians — not ten roster names.

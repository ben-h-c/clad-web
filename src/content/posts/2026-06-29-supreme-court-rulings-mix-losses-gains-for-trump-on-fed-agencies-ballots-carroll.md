---
type: "broadcast"
headline: "Supreme Court rulings mix losses, gains for Trump on Fed, agencies, ballots, Carroll case"
...
publishedAt: 2026-06-29T23:55:33.000Z
sourceUrl: "https://www.youtube.com/watch?v=ZIQWMpAUCFo"
sourceTitle: "MS NOW"
section: "Politics"
letterGrade: "B+"
factualityScore: 85
politicalLean: "left"
leanScore: -72
leanRationale: "Strong left tilt via terms like 'plot', 'impunity', 'MAGA court', one-sided sourcing, and emphasis on threats to democracy and agency independence"
gradeRationale: "Claims on specific SCOTUS rulings (Carroll appeal denial, ballot counting, Lisa Cook firing block, independent agency power expansion) verified by multiple primary and reputable sources; minor issues from loaded framing and selective emphasis"
topics:
  - "Supreme Court"
  - "Trump administration"
  - "Federal Reserve"
  - "Elections"
assessment: "The core factual reporting on rulings holds up against contemporaneous court records and coverage from outlets including SCOTUSblog, NPR, and the Guardian. Viewers may miss nuance on the Fed's unique statutory structure and historical tradition noted in opinions, or the narrower scope of the ballot decision limited to postmark/receipt windows. Loaded language frames decisions as part of a 'plot' and grants of 'impunity,' skewing perception toward alarm over expanded presidential power. The broadcast correctly flags the split outcomes and 5-4 alignments but omits full counterarguments on Article II removal authority or state election flexibility. Overall accurate but partisan in tone and emphasis."
notableConcerns:
  - "Loaded language and selective framing amplify narrative of judicial inconsistency and power grabs"
keyMoments:
  - claim: "SCOTUS refuses Trump's appeal in E. Jean Carroll defamation case"
    verdict: "verified"
    note: "Multiple sources confirm denial of review, leaving $5M verdict intact"
  - claim: "SCOTUS rules 5-4 to allow counting of late mail ballots postmarked by Election Day"
    verdict: "verified"
    note: "Upheld Mississippi-style grace periods; Roberts and Barrett joined majority against GOP challenge"
  - claim: "SCOTUS 5-4 blocks Trump from firing Fed Gov. Lisa Cook; Roberts and Kavanaugh join liberals"
    verdict: "verified"
    note: "Cook remains pending further litigation; due process concerns cited"
  - claim: "SCOTUS expands Trump's power to fire officials at independent agencies like FTC"
    verdict: "verified"
    note: "Overturns longstanding precedent; major structural change to government noted in coverage"
videoId: "ZIQWMpAUCFo"
...
citations:
  ...
  - title: "Supreme Court rejects Trump's appeal of 2022 E. Jean Carroll defamation case"
    url: "https://abcnews.com/US/supreme-court-rejects-trumps-appeal-2022-jean-carroll/story?id=134308966"
  - title: "Supreme Court cements Trump's power over agencies long considered independent"

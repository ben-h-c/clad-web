...
leanScore: 5
leanRationale: "Presents Trump's claims alongside Democratic and Republican skepticism without heavy framing or selective emphasis"
gradeRationale: "Mostly accurate summary of reported events with direct quotes from officials; minor issues from lack of released text and unverified specifics on blockade or sanctions"
topics:
  - "Iran"
  - "G7 summit"
  - "US-Iran deal"
...
notableConcerns: []
keyMoments:
  - claim: "Trump touts peace deal with Iran at G7 in France to end nearly four-month war"
    verdict: "verified"
    note: "Confirmed by contemporaneous reports from NPR, CNN, PBS and others on Trump's G7 arrival and statements"
  - claim: "Deal states Iran will never have a nuclear weapon and Strait of Hormuz will be open"
    verdict: "verified"
    note: "Directly attributed to Trump in multiple sources including PBS and Al Jazeera coverage"
  - claim: "MOU for signing in Geneva, extends ceasefire, reopens strait while negotiating nuclear program"
    verdict: "verified"
    note: "Matches reporting on preliminary framework/MOU with signing planned Friday"
  - claim: "Schumer calls for briefings; Kennedy doubts Iran compliance and suggests Senate approval"
    verdict: "verified"
    note: "Schumer statements widely reported; Kennedy-style skepticism aligns with Republican concerns noted in coverage"
  - claim: "Trump agrees to send deal to Congress"
    verdict: "verified"
    note: "Trump stated he would send it to lawmakers per CNN and other reports"
videoId: "EC5BqlOWWxA"
...
citations:
  ...
  - title: "Trump vows to release text of Iran agreement 'in a couple of days'"
    url: "https://edition.cnn.com/2026/06/16/world/live-news/iran-war-g7-summit"
  - title: "WATCH: Trump predicts 'great things' from Iran deal as he meets with Macron at G7"
  ...
  - title: "Top Democrats keep Trump's Iran deal at arms length"
    url: "https://kfoxtv.com/news/nation-world/top-democrats-hakeem-jeffries-chuck-schumer-keep-president-trumps-iran-war-deal-at-arms-length"

...
export const POLITICIAN_PHOTOS: Record<string, string> = {
  ...
  "mike-rogers-mi": "https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Mike-Rogers-Head-Shot-2_%283x4_cropped%29.jpg/330px-Mike-Rogers-Head-Shot-2_%283x4_cropped%29.jpg",
...
export const POLITICIAN_WIKI: Record<string, string> = {
  ...
  "mike-rogers": "Mike_Rogers_(Alabama_politician)",
  "mike-rogers-mi": "Mike_Rogers_(Michigan_politician)",

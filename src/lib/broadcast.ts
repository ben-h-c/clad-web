...
{
  "headline": "<a concise news headline for this report, <= 90 chars>",
...
Tone: restrained editorial, not tabloid. No emoji, no exclamation marks. Adjectives describe evidence ("documented", "unsubstantiated"), not people. Verdicts key off documents, statutes, primary data, and named sources. Where evidence is genuinely thin, prefer "missing context" or "unsupported" over guessing.
